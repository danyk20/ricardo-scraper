...
- `category` filtering now also accepts a category name (e.g.
  `"notebooks"`), not just Ricardo's numeric id (`"39272"`) -- previously
  any non-numeric value silently matched nothing.
